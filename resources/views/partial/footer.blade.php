        ...
        <div class="row">
            <div class="col-lg-3 col-md-7 offset-md-1 offset-lg-0">
                ...
                <div class="block about">
                    <!-- footer logo -->
                    <!-- <img src="images/home/2.png" width="100px" height="100px" alt=""> -->
                    <h2 class="text-white mb-2 text-left">Logistics Portal</h2>
                    <!-- description -->
                    <ul class="social-media-icons text-left">
                        <li><a class="fa fa-facebook facebook" href="https://www.facebook.com/themefisher" target="_blank"></a></li>
